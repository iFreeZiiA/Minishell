...
main() {
    ...
    echo -e "${CYAN}🧪 TESTS DE ROBUSTESSE - DÉTECTION DE CRASHES${NC}"
    echo -e "${CYAN}===============================================${NC}"
    echo "🎯 Objectif: Vérifier que minishell ne crash pas sur des inputs limites"
    echo ""
    ...
    if [ $FAILED_TESTS -eq 0 ]; then
        ...
        echo -e "🛡️  Votre minishell est robuste aux cas limites."
    else
