...
/*   Updated: 2025/08/09 11:21:13 by jjorda           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * @brief Finds rightmost operator with specific precedence (for left-to-right
 * evaluation)
 * 
 * @param start Start of token range
 * @param end End of token range
 ...
 */
t_list		*ft_find_rightmost_operator_by_precedence(t_list *start,
				t_list *end, int precedence);
